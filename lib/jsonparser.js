...
phssr.makeHTMLPage = function(tableHtml, reporterOptions){
    ...
    staticHTMLContentprefix +=  "<h2 align='center' onclick='javascript:(function(){\n$(\"a[onclick*=toggle]\").click()\n})()'>Detail Report</h2>";
...
function buildSummaryReport() {
    ...
    var header = "<h2 align='center'>Summary Report</h2>" +
        "<table>" +
        "<tr class='header' align='center'><th>Test suite</th><th>Total cases</th><th onclick=_PASS_>Pass</th><th onclick=_FAIL_>Fail</th></tr>";
    ...
    JSON2File({"url": baseUrl, "total": totalTest, "pass": totalPass, "startTime": (StartTestTime || 0)}, reportPath, (SummaryReportName || "sreport.json"));
    return htmlCode;
}
