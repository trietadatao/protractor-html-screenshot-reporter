...
phssr.makeHTMLPage = function(tableHtml, reporterOptions){
    ...
    staticHTMLContentprefix +=  "<h2 align='center'>Detail Report</h2>" + "<table class='header'>";
...
function processJson(jsonData, options){
    ...
    function parseJSON(element) {
        if(element.children){
            ...
            jsonStr += '<li align="center">'+element.desc+ '<ul>';
    ...
    tableHtml += "<p><b>This report generated on "+new Date()+" </b></p>";
...
function buildSummaryReport() {
    ...
    var htmlCode = "<h2 align='center'>Summary Report</h2>" +
        "<table>" +
        "<tr style='background-color: gray;color: white; text-align: center;'><th>Test suite</th><th>Total cases</th><th>Pass</th><th>Fail</th></tr>";
