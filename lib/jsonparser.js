...
function buildSummaryReport() {
    ...
    htmlCode += "<h2 align='center'>Summary Report</h2>" +
        "<table>" +
        "<tr class='header' align='center'><th>Test suite</th><th>Total cases</th><th>Pass</th><th onclick=\"javascript:(function(){$('tr:nth-child(2):has(td:contains(true))').toggle()})()\">Fail</th></tr>";
